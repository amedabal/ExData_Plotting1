## the file was downloaded and unziped in my local director
# read the data file from 
power <- read.table("c:/datasciencecoursera/data/household_power_consumption.txt", header=T, sep=";")
...
#Global active power
plot2 <- function() {
        plot(gData$timestamp,gData$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
